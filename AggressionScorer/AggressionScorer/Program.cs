...
namespace AggressionScorer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IDataView trainingDataView = mlContext.Data.LoadFromTextFile<UserInput>(
        ...
        //    IDataView inputDataView = mlContext.Data.LoadFromTextFile<UserInput>(
        //        path: createdInputFile,
        //        hasHeader: true,
        //        separatorChar: '\t',
        //        allowQuoting: true
